...
const socket = io("https://collaborative-code-editor-8vqb.onrender.com/");
    ...
    return (
      <div className="join-container">
        <div className="join-header">
          <h1 className="codehub-title">CodeHub</h1>
          <p className="codehub-description">
            Real-time collaborative code editor with compiler support. Ideal for learning, pair programming, and team projects.
          </p>
        </div>
